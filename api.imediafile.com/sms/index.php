...
if(isset($_GET['accessToken']) && $_GET['accessToken'] === 'da3ZPeqPv8EQB9gpWp7D8mDu'){
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* -------------------------------------------------------------------------- */
if(isset($_GET['brand']) && $_GET['brand'] == 'mycoiner'){
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
$data = '{"message": "' . $message . '", "recipients": ["' . trim($phone) . '"], "channel": 354839}';
/* -------------------------------------------------------------------------- */
$ch = curl_init();
...
//file_get_contents("http://62.168.42.38:9187/cgi/WebCGI?1500101=account=api&password=rcq2sXPB&port=2&destination=$phone&content=" . rawurlencode($message));
...
/* -------------------------------------------------------------------------- */
// GB - CUSTOM CHANNEL VIRAROSI
if($substr == '0044' || $substr = '00357'){
/* -------------------------------------------------------------------------- */
